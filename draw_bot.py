...
viewBox_start_x, viewBox_start_y, viewBox_end_x, viewBox_end_y = parse_svg(file_path)
drawing_width, drawing_heigt = (viewBox_end_x - viewBox_start_x), (viewBox_end_y - viewBox_start_y)

#calculate scale and find optimum scale rate
...
#test
print(scale_rate, start_x, start_y)